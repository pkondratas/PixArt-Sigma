    ...
    for epoch in range(start_epoch + 1, config.num_epochs + 1):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if load_vae_feat:
                ...
                with torch.no_grad():
                    # with torch.amp.autocast(device_type='cuda', enabled=(config.mixed_precision == 'fp16' or config.mixed_precision == 'bf16')):
                    input_tensor = batch[0].to(dtype=next(vae.parameters()).dtype)
...
if __name__ == '__main__':
    ...
    #     try:
    #         print("aaa")
    #         print(args.tracker_project_name)
